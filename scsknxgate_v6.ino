...
//  char devCall = devIx;
  ...
  { //1 replyLen==4 && replyBuffer == 0xF3 'u'
    char device = replyBuffer[2];
...
//          else
        ...
        device = 0;
        devtype = 0;
      } // 3                           // <------------ indirizzato a TUTTI i devices
      else
      {
      ...
      { // 3 device valido & evitare doppioni
        prevDevice = device;
        prevAction = action;
  ...
  // ----------------------------------------------------------------------------------------------------
    ...
    // ======================================== P U B B L I C A Z I O N E ===========================================
      ...
      } // 3       // evitare doppioni & device valido
    } // 2 - <-replyBuffer[4] == 0x12---------------------comando----------------------------
  // ----------------------------------------------------------------------------------------------------
    else
